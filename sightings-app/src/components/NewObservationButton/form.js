...
function ObservationForm() {
    ...
    const getObservations = async() => {
        try {
            const ObservationsData = await client.graphql({query: queries.listObservations});
        ...
        try {
            ...
            const imageKeys = await Promise.all(
                Array.from(files).map(async (file) => {
                  const result = await uploadData({path: `public/${Observation.id}-${file.name}.png`, data: file, options: {contentType: 'image/png'}}).result;
                  return result.key;
                })
              );
            ...
            // Persist new Contact
            await client.graphql({query: mutations.createObservation, variables: {input: newsObservation}});
            handleClose();
        } catch(err) {
            console.log('error', err);
        }
                    ...
                    <Modal.Body>
                        <Form>
                            ...
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control as="select" name="timeName" value={formData.timeName} 
                                    onChange={evt => setFormData({...formData, timeName: evt.target.value})}>
                            ...
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control type="text" placeholder="Enter report type" name="reportType" value={formData.reportType} 
                                onChange={evt => setFormData({...formData, reportType: evt.target.value})} />
                            </Form.Group>
                            ...
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control as="select" name="specie" value={formData.specie} 
                                    onChange={evt => setFormData({...formData, specie: evt.target.value})}>
                            ...
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control type="text" placeholder="Enter reporter's name" name="reporter" value={formData.reporter} 
                                onChange={evt => setFormData({...formData, reporter: evt.target.value})} />
                            </Form.Group>
                            ...
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control as="select" name="stage" value={formData.stage} 
                            ...
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control as="select" name="sex" value={formData.sex} 
                            ...
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control as="select" name="condition" value={formData.condition} 
                            ...
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control type="text" placeholder="Enter length" name="length" value={formData.length} 
                                onChange={evt => setFormData({...formData, length: evt.target.value})} />
                            </Form.Group>

                            <Form.Group className="mb-3">
                                <Form.Label>Disk Length</Form.Label>
                                <Form.Control type="text" placeholder="Enter disk length" name="diskLength" value={formData.diskLength} 
                                onChange={evt => setFormData({...formData, diskLength: evt.target.value})} />
                            </Form.Group>

                            <Form.Group className="mb-3">
                                <Form.Label>Width</Form.Label>
                                <Form.Control type="text" placeholder="Enter width" name="width" value={formData.width} 
                                onChange={evt => setFormData({...formData, width: evt.target.value})} />
                            </Form.Group>

                            <Form.Group className="mb-3">
                                <Form.Label>Depth</Form.Label>
                                <Form.Control type="text" placeholder="Enter depth" name="depth" value={formData.depth} 
                                onChange={evt => setFormData({...formData, depth: evt.target.value})} />
                            </Form.Group>

                            <Form.Group className="mb-3">
                                <Form.Label>Distance</Form.Label>
                                <Form.Control type="text" placeholder="Enter distance" name="distance" value={formData.distance} 
                                onChange={evt => setFormData({...formData, distance: evt.target.value})} />
                            </Form.Group>

                            <Form.Group className="mb-3">
                                <Form.Label>Temperature</Form.Label>
                                <Form.Control type="text" placeholder="Enter temperature" name="temperature" value={formData.temperature} 
                            ...
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control as="textarea" rows={3} placeholder="Enter description" name="description" value={formData.description} 
                                onChange={evt => setFormData({...formData, description: evt.target.value})} />
                            </Form.Group>

                            <Form.Group className="mb-3">
                                <Form.Label>Comments</Form.Label>
                                <Form.Control as="textarea" rows={3} placeholder="Enter comments" name="comments" value={formData.comments} 
                                onChange={evt => setFormData({...formData, comments: evt.target.value})} />
                            </Form.Group>

                            <Form.Group className="mb-3">
                                <Form.Label>URL Links</Form.Label>
                                <Form.Control type="text" placeholder="Enter URL links" name="urlLinks" value={formData.urlLinks} 
                                onChange={evt => setFormData({...formData, urlLinks: evt.target.value})} />
                            </Form.Group>

                            <Form.Group className="mb-3">
                                <Form.Label>By User</Form.Label>
                                <Form.Control type="text" placeholder="Enter user" name="byUser" value={formData.byUser} 
                                onChange={evt => setFormData({...formData, byUser: evt.target.value})} />
                            </Form.Group>

                            <Form.Group className="mb-3">
                                <Form.Label>Checked By User</Form.Label>
                                <Form.Control type="text" placeholder="Enter user who checked" name="checkedByUser" value={formData.checkedByUser} 
                                onChange={evt => setFormData({...formData, checkedByUser: evt.target.value})} />
                            </Form.Group>

                            <Form.Group className="mb-3">
                                <Form.Label>Substrate</Form.Label>
                                <Form.Control as="select" name="substrate" value={formData.substrate} 
                            ...
                            <Form.Group className="mb-3">
                                ...
                                <Form.Control type="text" placeholder="Enter weight" name="weight" value={formData.weight} 
                                onChange={evt => setFormData({...formData, weight: evt.target.value})} />
                            </Form.Group>                        

                            <Form.Group className="mb-3">
                                <Form.Label>Media</Form.Label>
                                <Form.Control type="file" multiple onChange={(evt) => setFiles(Array.from(evt.target.files))} />
